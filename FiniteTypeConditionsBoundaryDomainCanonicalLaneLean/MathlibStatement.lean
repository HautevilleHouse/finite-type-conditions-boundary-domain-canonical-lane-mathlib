...
def mathlibProofObligation : MathlibProofObligation := {
  sourceKey := "finite-type-conditions-boundary-domain",
  theoremObject := "Finite Type Conditions Boundary Domain",
...
def theoremSpecificEndgamePilotClosed : Prop :=
  forall A : AdmissibleClass, ConstrainedFiniteTypeClosure A

theorem theorem_specific_endgame_pilot_checked :
    theoremSpecificEndgamePilotClosed := by
  intro A
  exact constrained_finite_type_endgame A
